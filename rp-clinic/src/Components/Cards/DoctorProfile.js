    ...
    <div className='profile-maain-div'>
        <div className='img-description-wrapper'>
            <div className='profile-name-img-div'>
                ...
                <br/>MBBS, MS, DNB (ORTHO)          
            </div>
            <div className='profile-description'>
                <span className='name-heading'>Know Your Doctor</span><br/>
                <span className='profile-details'>
                    Dr. Sanjay is an eperienced doctor having 8+ years of experience in the field of OrthopedicsHe had served some of countrie's 
